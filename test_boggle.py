...
class TestBoggle(unittest.TestCase):
    ...
    def test_can_create_an_empty_grid(self):
        ...
        """
        so boggle for the boggle file, make grid for the make grid function in boggle and 0,0 for the height and width
        """
        self.assertEqual(len(grid),0)
        
    def test_grid_size_is_width_times_height(self):
        """
        Test is to ensure that the total size of the grid is equal to width x height
        """
    ...
    def test_grid_coordinates(self):
        """
        test to ensure that all the coordinates inside the grid can be accessed
        """
    ...
    def test_grid_is_filled_with_letters(self):
        """
        Ensure that each of the coordinates int he frid contains a letter
        """
        grid = boggle.make_grid(2, 3)
    ...
    def test_converting_a_word_to_a_path(self):
        """
    ...
    def test_search_grid_for_words(self):
        """
        Ensure that certain patterns can be found in a path_to_word. JW Note - This is a dictionary stored in a variable.
        """
